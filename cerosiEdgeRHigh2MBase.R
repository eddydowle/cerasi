...
sum(table1$c_Hi_3M_03_exp_count) #19362950 = sum of mapped reads (10345338+9017617)
sum(table1$c_Hi_3M_04_exp_count) #18718043 = sum of mapped reads (9136199+9581844)
sum(table1$c_Hi_3M_05_exp_count) #17375225 = sum of mapped reads (8213524+9161701)

sum(table1$c_Hi_2M_01_exp_count) #17736624 = sum of mapped reads (8367075+9369550)
sum(table1$c_Hi_2M_02_exp_count) #18932670 = sum of mapped reads (10034097+8898570)
sum(table1$c_Hi_2M_03_exp_count) #22470399 = sum of mapped reads (11779578+10690818)
sum(table1$c_Hi_2M_04_exp_count) #17709193 = sum of mapped reads (8399496+9309697)

sum(table1$c_Lo_3M_01_exp_count) #22368025 
sum(table1$c_Lo_3M_02_exp_count) #19716683  
sum(table1$c_Lo_3M_03_exp_count) #22687472  
sum(table1$c_Lo_3M_04_exp_count) #22639264  
...
#bottom right
legend(2.5,2.3,bty = "n",legend=(c("2 mo.","2.5 mo.","3 mo.","3.5 mo.","4 mo.","4.5 mo.","Hi","Low")),pch = c(2,15,19,4,5,7,18,18),col=c("black","black","black","black","black","black","green4","purple4"))
