...
colnames(table.low)
write.table(table.low,"BackToHigh2Mremove3Mand25sample/Table.cerosi.low",quote=FALSE,row.names=FALSE,sep="\t")
#High
...
colnames(table.high)
write.table(table.high,"BackToHigh2Mremove3Mand25sample/Table.cerosi.high",quote=FALSE,row.names=FALSE,sep="\t")
